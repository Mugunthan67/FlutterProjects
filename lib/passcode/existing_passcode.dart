...
class ExistingPasscode extends StatefulWidget {
  const ExistingPasscode({Key? key, required String Value}) : super(key: key);

  @override
  State<ExistingPasscode> createState() => _ExistingPasscodeState();
}

class _ExistingPasscodeState extends State<ExistingPasscode> {
    ...
    return Scaffold(
      ...
      body: Column(children: [
                          ...
                          if (inputText.length == 5) {
                            ...
                            if (inputText == "12457") {
                              ...
                              setState(() {
                               Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const NewPasscode(Value: '',)),
                );
                                message = "Sucess";
                              });
                            } else {
        ...
        Container(
          ...
          height: 80,
          width: 200,
          child: Text("Forgot you passcode?",style: TextStyle(color: Color.fromRGBO( 12,
                                  177,
                                  223,
                                  1,)),),
        )
